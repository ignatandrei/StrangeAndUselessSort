...
public partial class ThanosSortWithOperatorsTestFeature : FeatureFixture
{
    ...
    private async Task When_ThanosSortWithOperators_is_called()
    {
        await Task.Yield();
        resultArray = StrangeAndUselessSort.SortMethods.ThanosSortWithOperators(inputArray ?? Array.Empty<int>());
    }
